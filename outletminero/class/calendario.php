	...
	<form id="form" name="form" enctype="multipart/form-data" method="post" action="?F=calendario&amp;_f=addEvento">
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="5">
		...
		<tr>
		  ...
		  <td valign="top"><input name="hora" type="text" id="hora" size="60" maxlength="10" value="'. $hora .'" /></td>
		</tr>
		<tr>
		  <td valign="top" class="txtCont2" width="150">Lugar:</td>
		  <td valign="top"><input name="lugar" type="text" id="lugar" size="60" maxlength="10" value="'. $lugar .'" /></td>
		</tr>
		<tr>
